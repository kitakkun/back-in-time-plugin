...
import com.github.kitakkun.backintime.compiler.backend.transformer.BackInTimeDebuggableClassTransformer
...
class BackInTimeIrGenerationExtension(
    ...
    override fun generate(moduleFragment: IrModuleFragment, pluginContext: IrPluginContext) {
        ...
        with(context) {
            moduleFragment.transformChildrenVoid(BackInTimeDebuggableClassTransformer())
        }
    }
}
