...
fun InspectorScreen(
    ...
    InspectorScreen(
        ...
        onPerformBackInTime = { eventEmitter.tryEmit(InspectorScreenEvent.BackInTime(it)) },
...
fun InspectorScreen(
    ...
    onPerformBackInTime: (EventItemUiState) -> Unit,
        ...
        VerticalSplitLayout(
            ...
            second = {
                HistorySection(
                    ...
                    onPerformBackInTime = onPerformBackInTime,
                )
            },
            firstPaneMinWidth = 200.dp,
            secondPaneMinWidth = 200.dp,
