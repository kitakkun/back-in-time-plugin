package io.github.kitakkun.backintime.gradle
...
class BackInTimeGradlePlugin : KotlinCompilerPluginSupportPlugin {
    ...
    override fun apply(target: Project) {
        with(target) {
            ...
            val annotationDependencyNotation = "io.github.kitakkun.backintime:core-annotations:$VERSION"
            val runtimeDependencyNotation = "io.github.kitakkun.backintime:core-runtime:$VERSION"
            val eventDependencyNotation = "io.github.kitakkun.backintime:core-websocket-event:$VERSION"
