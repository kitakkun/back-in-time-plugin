...
object BackInTimeConsts {
    val backInTimeDebuggableInterfaceClassId = classId("io.github.kitakkun.backintime.runtime", "BackInTimeDebuggable")
    ...
    val propertyInfoClassId = classId("io.github.kitakkun.backintime.websocket.event.model", "PropertyInfo")
    ...
    val backInTimeJsonCallableId = CallableId(FqName("io.github.kitakkun.backintime.runtime"), Name.identifier("backInTimeJson"))
